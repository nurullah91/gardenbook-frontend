...
export default function RecentImageGallery({ images }: IImageGalleryProps) {
  return (
    <div>
      <LightGallery
        elementClassNames={`mt-6 gap-2 grid grid-cols-2 md:grid-cols-4`}
        speed={500}
      ...
      >
        {images.map((image, index) => (
          ...
          >
            <Image
              src={image}
              width={images.length === 3 && index === 0 ? 1000 : 500}
              height={500}
